...
struct proc {
  ...
  int timeslice;                // Assigned time slice
  int currticks;                // number of timer ticks this process has scheduled
  int currcomp;                 // number of compensation ticks this process currently has
  int deadline;                 // time to wake up
  ...
  int in_queue;                 // boolean, whether this proc is in the scheduling queue
  void *next;                   // next proc
};
